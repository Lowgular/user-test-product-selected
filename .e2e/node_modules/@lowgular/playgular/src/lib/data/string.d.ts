...
export declare const stringifyJSON: (json: any) => string;
export declare function trim(p: string): string;
export declare const insertInContent: (content: string, toInsert: string, position: number) => string;
export declare const cleanSpaces: (str: string) => string;
export declare const cleanComments: (data: string) => string;
export declare const cleanStringQuotes: (s: string) => string;
export declare const thirdPersonalize: (p: string) => string;
export declare const singularize: (word: string) => string;
